...
import { useCompetitionCategoryForm } from "@/hooks/dashboard/competition-categories";
...
interface Props {
  form: ReturnType<typeof useCompetitionCategoryForm>["form"];
...
export default CompetitionCategoryForm;
