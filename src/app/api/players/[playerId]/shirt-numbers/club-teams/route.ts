...
import { getPlayerClubTeamShirtNumbersService } from "@/lib/services/player-shirt-numbers.service";
...
export async function GET(
  ...
  try {
    ...
    const data = await getPlayerClubTeamShirtNumbersService(playerId, query);
